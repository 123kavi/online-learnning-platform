...
const getUsers = (req, res) => {
  User.getAllUsers((err, results) => {
    if (err) return res.status(500).send({ error: 'Error retrieving users' });
...
module.exports = { getUsers, createUserAccount, updateUserDetails, removeUser,getUserById ,updateUserById};
